...
export default function HomeFormSection() {
  return (
    // <section className="grid justify-center justify-items-center gap-12 lg:gap-24 lg:grid-cols-2 px-24 py-16 md:px-12 md:py-24 lg:px-32 max-w-[100vw] w-[100vw] lg:py-24 items-center">
    //   <motion.img 
    ...
    //     className="max-h-[1300px] max-w-full"
    //   />
    //   <ContactForm title={<span><span className="text-hidden-teal-dark">Change</span> the Way You Hire</span>} />
    //   {/* <motion.form
    //     initial={{ opacity: 0, y: 200 }} 
    //     whileInView={{ opacity: 1, y: 0 }} 
    //     viewport={{ once: true }} 
