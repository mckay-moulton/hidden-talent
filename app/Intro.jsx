      ...
      <section className='flex flex-col gap-8 lg:gap-16 px-4 py-12 lg:py-16 items-center relative'>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="grid gap-6 md:px-16">
            <h2 id="talent-h2" className="text-[29px] md:text-[42px] text-center"><span className="text-hidden-teal">Talent</span> We Have Discovered</h2>
            <div id="talent" className="border border-hidden-teal rounded-[20px] p-5 md:p-6 grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-6 max-w-[620px] mx-auto">
          ...
          <div id="areas" className="grid gap-6 md:px-16">
            <h2 id="areas-h2" className="text-[29px] md:text-[42px] text-center">Where We <span className="text-hidden-teal">Serve</span></h2>
            <img id="areas-served" src="https://media.hirehiddentalent.com/images/homepage-images/areas-served" alt="Alaska, Oregon, Idaho, Montana, Wyoming, Nevada, Utah, Arizona, New Mexico" />
          </div>
        </div>
